...
if prompt := st.chat_input("Zadaj pytanie dotyczące regulaminu..."):
    ...
    - Jeśli student podał i średnią, i punkty dodatkowe, DODAJ JE DO SIEBIE. Otrzymaną sumę odszukaj w tabeli "Łączna liczba punktów" i podaj mu ostateczną, konkretną kwotę przypisaną do tego progu z tabeli.    6. LOGIKA BRAKU DANYCH (Koszty podróży/Erasmus): Jeśli odpowiedź o dofinansowaniu zależy od kilometrów, a użytkownik ich nie podał, nie odrzucaj pytania. Poproś go o podanie odległości lub miasta docelowego.
